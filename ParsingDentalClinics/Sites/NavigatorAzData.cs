                ...
                () =>
                {
                    try
                    {
                        ...
                        var pageLast =
                            doc.DocumentNode.Descendants("a")
                                .Last(
                                    ...
                                    && x.Attributes["href"].Value.Contains("/catalogue/16/42/page"))
                        ...
                        for (var i = pagesSum; i > 0; i--)
                        {
                            doc =
                                new HtmlWeb().Load(
                                    string.Format("http://www.navigator.az/catalogue/16/42/page{0}.html", i));
                            ...
                            var clinics =
                                doc.DocumentNode.Descendants("div")
                                    .Where(
                                        ...
                                        && x.Attributes["class"].Value == "div_gray_solid_news");
                                    ...
                                    new InfoHolder
                                        {
                                            ...
                                            Address =
                                                RegExHelper.RegExpression(
                                                    clinic.Descendants("td")
                                                .Where(
                                                    x =>
                                                    x.Attributes.Contains("class")
                                                    && x.Attributes["class"].Value == "td_commontext_11")
                                                .ElementAt(1)
                                                .InnerText),
                                            Phone =
                                                RegExHelper.RegExpression(
                    ...
                    {
                        Console.WriteLine("Error in NavigatorAzData {0}", ex.Message);
