        ...
        public static async Task<IEnumerable<InfoHolder>> GetInfo()
        {
            return await Task.Run(
                () =>
                {
                        ...
                        for (var i = pageLast; i > 0; i--)
                        {
                            ...
                            var clinicsUrl =
                                doc.DocumentNode.Descendants("div")
                                    .First(
                                        x =>
                                        x.Attributes.Contains("class") && x.Attributes["class"].Value == "clinic-list")
                                    .Descendants("div")
                                            ...
                                            return new InfoHolder
                                                       {
                                                           ...
                                                           Address =
                                                               ...
                                                               .First(
                                                                   ...
                                                                   && x.Attributes["class"].Value
                                                                   == "adress")
                                                               .ChildNodes.First(x => x.Name == "span")
                                                               .InnerText),
                                                           Phone =
                                                               RegExHelper.RegExpression(
                                                                   doc.DocumentNode.Descendants("div")
                    ...
                    {
                        Console.WriteLine("Error in StartsmileKzData {0}", ex.Message);
